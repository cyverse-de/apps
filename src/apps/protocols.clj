...
(defprotocol Apps
  ...
  (shareApps [_ admin? sharing-requests])
  (shareAppsWithSubject [_ admin? app-names sharee user-app-sharing-requests])
  (shareAppWithSubject [_ admin? app-names sharee system-id app-id level])
  (unshareApps [_ admin? unsharing-requests])
  (unshareAppsWithSubject [_ admin? app-names sharee app-unsharing-requests])
